...
## Títulos
- Episódio 1 - sinais de alerta
- Episódio 2 - a última despedida

## Ganchos
- Episódio 1: O que mais pode acontecer em uma manhã que parecia comum? Não perca a próxima parte.
- Episódio 2: Como Márcia lidará com essa perda devastadora? Descubra no próximo capítulo.
...
Capítulo: 001
WPM usado: 0
Palavras: 4049 | Parágrafos: 1 | Estimativa total: 50.8 min
Decisão: 2 parte(s)

## Episódios
### Episódio 1 — Episódio 1 - sinais de alerta
Parágrafos: 1–12 | ~24.3 min
Gancho: O que mais pode acontecer em uma manhã que parecia comum? Não perca a próxima parte.

### Episódio 2 — Episódio 2 - a última despedida
...
```json
{
  ...
  "decision_pack": {
    "decision": 2,
    "rationale": "A decisão de segmentar a narrativa em duas partes se baseia na construção emocional crescente e na transição significativa entre a rotina cotidiana e o evento trágico. A primeira parte abrange a apresentação da relação entre Márcia e Rafael, enquanto a segunda parte foca na reviravolta dramática do acidente, proporcionando um impacto emocional mais forte.",
    "segments": [
      {
        "index": 1,
        "label": "Parte 1",
        ...
        "viral_title_core": "sinais de alerta",
        "end_hook_next": "O que mais pode acontecer em uma manhã que parecia comum? Não perca a próxima parte.",
        "notes": "",
        "display_title": "Episódio 1 - sinais de alerta"
      },
      {
        "index": 2,
        "label": "Parte 2",
        "start_paragraph": 13,
        "end_paragraph": 40,
        "estimated_minutes": 26.5,
        "viral_title_core": "a última despedida",
        "end_hook_next": "Como Márcia lidará com essa perda devastadora? Descubra no próximo capítulo.",
        "notes": "",
        "display_title": "Episódio 2 - a última despedida"
      }
    ],
    "totals": {
      "estimated_total_minutes": 50.8,
      "wpm_used": 0
    }
  },
  "final_titles": [
  ...
  "end_hooks_next": [
    "O que mais pode acontecer em uma manhã que parecia comum? Não perca a próxima parte.",
    "Como Márcia lidará com essa perda devastadora? Descubra no próximo capítulo."
  ],
  "warnings": []
}
```
